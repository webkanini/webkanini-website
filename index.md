...
<section id="process" style="background: #f8fafc;">
  ...
  <div class="services-grid">
    <div class="service-box"><img src="{{ '/assets/img/discover_search.png' | relative_url }}" alt="Discover"><h3>Discover</h3><p>We understand your business, challenges and goals.</p></div>
    ...
    <div class="service-box"><img src="{{ '/assets/img/implement_rocket.png' | relative_url }}" alt="Implement"><img src="{{ '/assets/img/implement_rocket.png' | relative_url }}" alt="Support"><h3>Implement</h3><p>We configure, test and deploy with minimal disruption.</p></div>
